        ...
        <>
            <div className="flex gap-8 items-center justify-center min-h-screen ">
                ...
                <div className="flex flex-col gap-4 ">
                    ...
                    <p className=" text-xl">La página que estas buscando no existe</p>
                    <a href="/" className="bg-primary text-white px-4 py-3 rounded-2xl text-center font-bold w-fit mt-5">Volver al inicio</a>
                </div>
